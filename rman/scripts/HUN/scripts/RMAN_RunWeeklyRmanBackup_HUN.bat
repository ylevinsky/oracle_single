...
set RMAN_Weekly_CMD_FILE="F:\Backup\Oracle\RMAN\scripts\RMAN_Weekly_backup_script_HUN.txt"
...
set logfile=F:\Backup\Oracle\RMAN\scripts\logs\Weekly_db_backup_log_%StartTime%.log
