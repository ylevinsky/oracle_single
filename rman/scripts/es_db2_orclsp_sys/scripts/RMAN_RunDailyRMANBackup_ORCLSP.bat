...
SET rman_backup_folder="F:\Oracle\Backup\RMAN\backup_files\ORCLSP\Incremental" 
set RMAN_Daily_CMD_FILE="F:\Oracle\Backup\RMAN\scripts\RMAN_Daily_backup_script_ORCLSP.txt"
...
set logfile=F:\Oracle\Backup\RMAN\logs\Daily_db_backup_log_%StartTime%.log
