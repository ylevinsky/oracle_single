...
SET rman_backup_folder="E:\oracle\backup_files\FLEX\RMAN_backup_files"
set RMAN_Weekly_CMD_FILE="E:\oracle\scripts\RMAN_Weekly_backup_script_FLEX.txt"
...
set logfile=E:\oracle\scripts\logs\Weeky_db_backup_log_%StartTime%.log
