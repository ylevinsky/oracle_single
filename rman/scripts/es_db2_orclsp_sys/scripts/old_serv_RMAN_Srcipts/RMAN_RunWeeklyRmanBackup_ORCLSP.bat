...
SET rman_backup_folder="G:\Oracle\Backup\RMAN\backup_files\ORCLSP\Full"
set %RMAN_Weekly_CMD_FILE="RMAN_Weekly_backup_script_ORCLSP.txt"
...
set logfile=logs\Weekly_db_backup_log_%StartTime%.log
