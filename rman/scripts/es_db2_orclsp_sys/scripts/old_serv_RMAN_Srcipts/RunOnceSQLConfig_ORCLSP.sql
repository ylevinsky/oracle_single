...
DELETE &1\RMAN\backup_files\rman_change_track_ORCLSP.f;
ALTER DATABASE ENABLE BLOCK CHANGE TRACKING USING FILE '&1\RMAN\backup_files\rman_change_track_ORCLSP.f' REUSE;
