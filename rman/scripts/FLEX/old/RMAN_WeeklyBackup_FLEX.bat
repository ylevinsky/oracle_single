...
set rman_backup_folder="\\192.168.0.125\Oracle\Backup_db2\RMAN\backup_files"
set RMAN_Daily_CMD_FILE="RMAN_Weekly_backup_script_FLEX.txt"
set sysUserAndPassword=sys/ProdE$$ence2015
set DbTnsName=FLEX_19
set SynCToY_Folder_Pair_Name="DuplicateOracleBackupFolder"


set StartTime=%dtStamp%

set logfile=weekly_db_backup_log.log
...
rman TARGET %sysUserAndPassword%@%DbTnsName% NOCATALOG cmdfile=%RMAN_Daily_CMD_FILE%  >> %logfile%
